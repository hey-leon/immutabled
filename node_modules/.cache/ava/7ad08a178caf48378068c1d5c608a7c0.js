...
var _concat = require('../../source/list/concat');
...
(0, _ava2.default)('list#concat: should be curryable', function (t) {
  t.is((0, _concat2.default)(_curry._), _concat2.default);
});

(0, _ava2.default)('list#concat: should return a list type', function (t) {
  var l1 = { __data__: [] };
  var l2 = { __data__: [] };

  t.is((0, _concat2.default)(l1, l2).__type__, _symbols2.default.list);
});

(0, _ava2.default)('list#concat: should call Array.prototype.concat w/ __data__', function (t) {
  var _rec = new _powerAssertRecorder();

  var l1 = { __data__: [] };
  var l2 = { __data__: [] };

  var Spy = _sinon2.default.spy(Array.prototype.concat, 'call');

  (0, _concat2.default)(l1, l2);

  t.true(_rec._expr(_rec._capt(_rec._capt(Spy, 'arguments/0/callee/object').calledWith(_rec._capt(_rec._capt(l1, 'arguments/0/arguments/0/object').__data__, 'arguments/0/arguments/0'), _rec._capt(_rec._capt(l2, 'arguments/0/arguments/1/object').__data__, 'arguments/0/arguments/1')), 'arguments/0'), {
    content: 't.true(Spy.calledWith(l1.__data__, l2.__data__))',
    filepath: 'tests/list/concat.spec.js',
    line: 34,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Spy","range":[7,10]},"property":{"type":"Identifier","name":"calledWith","range":[11,21]},"computed":false,"range":[7,21]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"l1","range":[22,24]},"property":{"type":"Identifier","name":"__data__","range":[25,33]},"computed":false,"range":[22,33]},{"type":"MemberExpression","object":{"type":"Identifier","name":"l2","range":[35,37]},"property":{"type":"Identifier","name":"__data__","range":[38,46]},"computed":false,"range":[35,46]}],"range":[7,47]}],"range":[0,48]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"Spy","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"calledWith","range":[11,21]},{"type":{"label":"("},"range":[21,22]},{"type":{"label":"name"},"value":"l1","range":[22,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"__data__","range":[25,33]},{"type":{"label":","},"range":[33,34]},{"type":{"label":"name"},"value":"l2","range":[35,37]},{"type":{"label":"."},"range":[37,38]},{"type":{"label":"name"},"value":"__data__","range":[38,46]},{"type":{"label":")"},"range":[46,47]},{"type":{"label":")"},"range":[47,48]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=../../node_modules/.cache/ava/7ad08a178caf48378068c1d5c608a7c0.js.map
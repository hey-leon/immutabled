...
var _del = require('../../source/list/del');
...
(0, _ava2.default)('list#del: should be curryable', function (t) {
  t.is((0, _del2.default)(_curry._), _del2.default);
});

(0, _ava2.default)('list#del: should del new value', function (t) {
  ...
  t.true(_rec._expr(_rec._capt((0, _helpers.testRefs)(_rec._capt(l1, 'arguments/0/arguments/0'), _rec._capt(l2, 'arguments/0/arguments/1'), _rec._capt([_rec._capt(k, 'arguments/0/arguments/2/elements/0')], 'arguments/0/arguments/2')), 'arguments/0'), {
    ...
    filepath: 'tests/list/del.spec.js',
    line: 26,
...
//# sourceMappingURL=../../node_modules/.cache/ava/fd85ae49b4103cc577696be9163ef3ef.js.map
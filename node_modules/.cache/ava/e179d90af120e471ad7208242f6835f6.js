...
var _fold = require('../../source/list/fold');
...
(0, _ava2.default)('list#fold: should be curryable', function (t) {
  t.is((0, _fold2.default)(_curry._), _fold2.default);
});

(0, _ava2.default)('list#fold: should call Array.prototype.reduce w/ __data__', function (t) {
  var _rec = new _powerAssertRecorder();

  var f = function f(acc, i) {
    return i;
  };
  var l = {
    __data__: []
  ...
  var Spy = _sinon2.default.spy(Array.prototype.reduce, 'call');

  (0, _fold2.default)(l, f, i);

  t.true(_rec._expr(_rec._capt(_rec._capt(Spy, 'arguments/0/callee/object').calledWith(_rec._capt(_rec._capt(l, 'arguments/0/arguments/0/object').__data__, 'arguments/0/arguments/0'), _rec._capt(f, 'arguments/0/arguments/1'), _rec._capt(i, 'arguments/0/arguments/2')), 'arguments/0'), {
    content: 't.true(Spy.calledWith(l.__data__, f, i))',
    filepath: 'tests/list/fold.spec.js',
    line: 27,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Spy","range":[7,10]},"property":{"type":"Identifier","name":"calledWith","range":[11,21]},"computed":false,"range":[7,21]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"l","range":[22,23]},"property":{"type":"Identifier","name":"__data__","range":[24,32]},"computed":false,"range":[22,32]},{"type":"Identifier","name":"f","range":[34,35]},{"type":"Identifier","name":"i","range":[37,38]}],"range":[7,39]}],"range":[0,40]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"Spy","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"calledWith","range":[11,21]},{"type":{"label":"("},"range":[21,22]},{"type":{"label":"name"},"value":"l","range":[22,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"__data__","range":[24,32]},{"type":{"label":","},"range":[32,33]},{"type":{"label":"name"},"value":"f","range":[34,35]},{"type":{"label":","},"range":[35,36]},{"type":{"label":"name"},"value":"i","range":[37,38]},{"type":{"label":")"},"range":[38,39]},{"type":{"label":")"},"range":[39,40]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=../../node_modules/.cache/ava/e179d90af120e471ad7208242f6835f6.js.map
...
var _push = require('../../source/list/push');
...
(0, _ava2.default)('list#push: should be curryable', function (t) {
  t.is((0, _push2.default)(_curry._), _push2.default);
});

(0, _ava2.default)('list#push: should push new value', function (t) {
  ...
  t.true(_rec._expr(_rec._capt((0, _helpers.testRefs)(_rec._capt(l1, 'arguments/0/arguments/0'), _rec._capt(l2, 'arguments/0/arguments/1'), _rec._capt([_rec._capt(k, 'arguments/0/arguments/2/elements/0')], 'arguments/0/arguments/2')), 'arguments/0'), {
    ...
    filepath: 'tests/list/push.spec.js',
    line: 27,
...
//# sourceMappingURL=../../node_modules/.cache/ava/0de544ae0a84d57c855a467933b22ffa.js.map
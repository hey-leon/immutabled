...
var _find = require('../../source/list/find');
...
(0, _ava2.default)('list#find: should be curryable', function (t) {
  t.is((0, _find2.default)(_curry._), _find2.default);
});

(0, _ava2.default)('list#find: should call Array.prototype.find w/ __data__', function (t) {
  ...
  var Spy = _sinon2.default.spy(Array.prototype.find, 'call');

  (0, _find2.default)(l, f);
  ...
  t.true(_rec._expr(_rec._capt(_rec._capt(Spy, 'arguments/0/callee/object').calledWith(_rec._capt(_rec._capt(l, 'arguments/0/arguments/0/object').__data__, 'arguments/0/arguments/0'), _rec._capt(f, 'arguments/0/arguments/1')), 'arguments/0'), {
    ...
    filepath: 'tests/list/find.spec.js',
    line: 27,
...
//# sourceMappingURL=../../node_modules/.cache/ava/b93d8102f0537bbfb005b99331de0bf5.js.map
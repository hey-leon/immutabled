...
var _set = require('../../source/list/set');
...
(0, _ava2.default)('list#set: should be curryable', function (t) {
  t.is((0, _set2.default)(_curry._), _set2.default);
});

(0, _ava2.default)('list#set: should set new value', function (t) {
  ...
  var l2 = (0, _set2.default)(l1, k, v);

  t.true(_rec._expr(_rec._capt((0, _helpers.testRefs)(_rec._capt(l1, 'arguments/0/arguments/0'), _rec._capt(l2, 'arguments/0/arguments/1'), _rec._capt([_rec._capt(k, 'arguments/0/arguments/2/elements/0')], 'arguments/0/arguments/2')), 'arguments/0'), {
    content: 't.true(testRefs(l1, l2, [k]))',
    filepath: 'tests/list/set.spec.js',
    line: 27,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"Identifier","name":"testRefs","range":[7,15]},"arguments":[{"type":"Identifier","name":"l1","range":[16,18]},{"type":"Identifier","name":"l2","range":[20,22]},{"type":"ArrayExpression","elements":[{"type":"Identifier","name":"k","range":[25,26]}],"range":[24,27]}],"range":[7,28]}],"range":[0,29]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"testRefs","range":[7,15]},{"type":{"label":"("},"range":[15,16]},{"type":{"label":"name"},"value":"l1","range":[16,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"l2","range":[20,22]},{"type":{"label":","},"range":[22,23]},{"type":{"label":"["},"range":[24,25]},{"type":{"label":"name"},"value":"k","range":[25,26]},{"type":{"label":"]"},"range":[26,27]},{"type":{"label":")"},"range":[27,28]},{"type":{"label":")"},"range":[28,29]}]',
...
(0, _ava2.default)('list#set: should overwrite value', function (t) {
  ...
  var l2 = (0, _set2.default)(l1, k, v2);

  t.true(_rec2._expr(_rec2._capt((0, _helpers.testRefs)(_rec2._capt(l1, 'arguments/0/arguments/0'), _rec2._capt(l2, 'arguments/0/arguments/1'), _rec2._capt([_rec2._capt(k, 'arguments/0/arguments/2/elements/0')], 'arguments/0/arguments/2')), 'arguments/0'), {
    content: 't.true(testRefs(l1, l2, [k]))',
    filepath: 'tests/list/set.spec.js',
    line: 46,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"Identifier","name":"testRefs","range":[7,15]},"arguments":[{"type":"Identifier","name":"l1","range":[16,18]},{"type":"Identifier","name":"l2","range":[20,22]},{"type":"ArrayExpression","elements":[{"type":"Identifier","name":"k","range":[25,26]}],"range":[24,27]}],"range":[7,28]}],"range":[0,29]}',
...
//# sourceMappingURL=../../node_modules/.cache/ava/139dd3ef089350ab3733ebb9a2aa3226.js.map
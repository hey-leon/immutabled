...
var _indexOf = require('../../source/list/indexOf');
...
(0, _ava2.default)('list#indexOf: should be curryable', function (t) {
  t.is((0, _indexOf2.default)(_curry._), _indexOf2.default);
});

(0, _ava2.default)('list#indexOf: should call Array.prototype.indexOf w/ __data__', function (t) {
  var _rec = new _powerAssertRecorder();

  var i = 1;
  var l = { __data__: [1] };

  var Spy = _sinon2.default.spy(Array.prototype.indexOf, 'call');

  (0, _indexOf2.default)(l, i);

  t.true(_rec._expr(_rec._capt(_rec._capt(Spy, 'arguments/0/callee/object').calledWith(_rec._capt(_rec._capt(l, 'arguments/0/arguments/0/object').__data__, 'arguments/0/arguments/0'), _rec._capt(i, 'arguments/0/arguments/1')), 'arguments/0'), {
    content: 't.true(Spy.calledWith(l.__data__, i))',
    filepath: 'tests/list/indexOf.spec.js',
    line: 25,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Spy","range":[7,10]},"property":{"type":"Identifier","name":"calledWith","range":[11,21]},"computed":false,"range":[7,21]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"l","range":[22,23]},"property":{"type":"Identifier","name":"__data__","range":[24,32]},"computed":false,"range":[22,32]},{"type":"Identifier","name":"i","range":[34,35]}],"range":[7,36]}],"range":[0,37]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"Spy","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"calledWith","range":[11,21]},{"type":{"label":"("},"range":[21,22]},{"type":{"label":"name"},"value":"l","range":[22,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"__data__","range":[24,32]},{"type":{"label":","},"range":[32,33]},{"type":{"label":"name"},"value":"i","range":[34,35]},{"type":{"label":")"},"range":[35,36]},{"type":{"label":")"},"range":[36,37]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=../../node_modules/.cache/ava/391aecb1ed8a42eed7b58d74bc3c0b8f.js.map
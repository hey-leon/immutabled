...
var _update = require('../../source/list/update');
...
(0, _ava2.default)('listp#update: should be curryable', function (t) {
  t.is((0, _update2.default)(_curry._), _update2.default);
});

(0, _ava2.default)('list#update: should update value', function (t) {
  ...
  var l2 = (0, _update2.default)(l1, k, function () {
  ...
  t.true(_rec._expr(_rec._capt((0, _helpers.testRefs)(_rec._capt(l1, 'arguments/0/arguments/0'), _rec._capt(l2, 'arguments/0/arguments/1'), _rec._capt([_rec._capt(k, 'arguments/0/arguments/2/elements/0')], 'arguments/0/arguments/2')), 'arguments/0'), {
    ...
    filepath: 'tests/list/update.spec.js',
    line: 27,
...
(0, _ava2.default)('list#update: should update when no value already', function (t) {
...
//# sourceMappingURL=../../node_modules/.cache/ava/e12fbfda136eaed865c391a0f99df84b.js.map
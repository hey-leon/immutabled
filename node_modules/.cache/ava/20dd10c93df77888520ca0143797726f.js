...
(0, _ava2.default)('exports: del is included', function (t) {
  var _rec12 = new _powerAssertRecorder();

  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(_map2.default, 'arguments/0/left/object').del, 'arguments/0/left') instanceof _rec12._capt(Function, 'arguments/0/right'), 'arguments/0'), {
    content: 't.true(map.del instanceof Function)',
    filepath: 'tests/map/index.spec.js',
    line: 63,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"instanceof","left":{"type":"MemberExpression","object":{"type":"Identifier","name":"map","range":[7,10]},"property":{"type":"Identifier","name":"del","range":[11,14]},"computed":false,"range":[7,14]},"right":{"type":"Identifier","name":"Function","range":[26,34]},"range":[7,34]}],"range":[0,35]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"map","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"del","range":[11,14]},{"type":{"label":"instanceof"},"value":"instanceof","range":[15,25]},{"type":{"label":"name"},"value":"Function","range":[26,34]},{"type":{"label":")"},"range":[34,35]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=../../node_modules/.cache/ava/20dd10c93df77888520ca0143797726f.js.map
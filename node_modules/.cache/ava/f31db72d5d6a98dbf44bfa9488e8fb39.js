...
var _some = require('../../source/list/some');
...
(0, _ava2.default)('list#some: should be curryable', function (t) {
  t.is((0, _some2.default)(_curry._), _some2.default);
});

(0, _ava2.default)('list#some: should call Array.prototype.some w/ __data__', function (t) {
  ...
  var Spy = _sinon2.default.spy(Array.prototype.some, 'call');

  (0, _some2.default)(l, f);
  ...
  t.true(_rec._expr(_rec._capt(_rec._capt(Spy, 'arguments/0/callee/object').calledWith(_rec._capt(_rec._capt(l, 'arguments/0/arguments/0/object').__data__, 'arguments/0/arguments/0'), _rec._capt(f, 'arguments/0/arguments/1')), 'arguments/0'), {
    ...
    filepath: 'tests/list/some.spec.js',
    line: 27,
...
//# sourceMappingURL=../../node_modules/.cache/ava/f31db72d5d6a98dbf44bfa9488e8fb39.js.map
...
var _pop = require('../../source/list/pop');
...
(0, _ava2.default)('list#pop: should be curryable', function (t) {
  t.is((0, _pop2.default)(_curry._), _pop2.default);
});

(0, _ava2.default)('list#pop: should pop new value', function (t) {
  ...
  t.true(_rec._expr(_rec._capt((0, _helpers.testRefs)(_rec._capt(l1, 'arguments/0/arguments/0'), _rec._capt(l2, 'arguments/0/arguments/1'), _rec._capt([_rec._capt(k, 'arguments/0/arguments/2/elements/0')], 'arguments/0/arguments/2')), 'arguments/0'), {
    ...
    filepath: 'tests/list/pop.spec.js',
    line: 28,
...
//# sourceMappingURL=../../node_modules/.cache/ava/e2c0fd6d0164d4be74e95a9bc3409a57.js.map
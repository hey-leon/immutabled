...
var _set = require('../../source/map/set');
...
(0, _ava2.default)('map#set: should be curryable', function (t) {
  t.is((0, _set2.default)(_curry._), _set2.default);
});

(0, _ava2.default)('map#set: should set new value', function (t) {
  ...
  t.true(_rec._expr(_rec._capt((0, _helpers.testRefs)(_rec._capt(m1, 'arguments/0/arguments/0'), _rec._capt(m2, 'arguments/0/arguments/1'), _rec._capt([_rec._capt(k, 'arguments/0/arguments/2/elements/0')], 'arguments/0/arguments/2')), 'arguments/0'), {
    ...
    filepath: 'tests/map/set.spec.js',
    line: 27,
...
(0, _ava2.default)('map#set: should overwrite value', function (t) {
  ...
  var m1 = {
    __data__: _defineProperty({}, k, v1),
    __size__: 0
  };

  var m2 = (0, _set2.default)(m1, k, v2);
...
//# sourceMappingURL=../../node_modules/.cache/ava/3cb6de68d022a6fb51f2bd8df42384ae.js.map
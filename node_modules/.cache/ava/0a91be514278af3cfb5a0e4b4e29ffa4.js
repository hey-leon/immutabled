...
var _map = require('../../source/list/map');
...
(0, _ava2.default)('list#map: should be curryable', function (t) {
  t.is((0, _map2.default)(_curry._), _map2.default);
});

(0, _ava2.default)('list#map: should return a list type', function (t) {
  var l = {
    __data__: []
  };

  t.is((0, _map2.default)(l, function (f) {
    return f;
  }).__type__, _symbols2.default.list);
});

(0, _ava2.default)('list#map: should call Array.prototype.map w/ __data__', function (t) {
  ...
  var Spy = _sinon2.default.spy(Array.prototype.map, 'call');
  ...
  t.true(_rec._expr(_rec._capt(_rec._capt(Spy, 'arguments/0/callee/object').calledWith(_rec._capt(_rec._capt(l, 'arguments/0/arguments/0/object').__data__, 'arguments/0/arguments/0'), _rec._capt(f, 'arguments/0/arguments/1')), 'arguments/0'), {
    ...
    filepath: 'tests/list/map.spec.js',
    line: 36,
...
//# sourceMappingURL=../../node_modules/.cache/ava/0a91be514278af3cfb5a0e4b4e29ffa4.js.map
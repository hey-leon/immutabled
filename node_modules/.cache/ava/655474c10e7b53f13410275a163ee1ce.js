...
var _sort = require('../../source/list/sort');
...
(0, _ava2.default)('list#sort: should be curryable', function (t) {
  t.is((0, _sort2.default)(_curry._), _sort2.default);
});

(0, _ava2.default)('list#sort: should return a list type', function (t) {
  var l = {
    __data__: []
  };

  t.is((0, _sort2.default)(l, function (f) {
    return f;
  }).__type__, _symbols2.default.list);
});

(0, _ava2.default)('list#sort: should call Array.prototype.sort w/ __data__', function (t) {
  ...
  var Spy = _sinon2.default.spy(Array.prototype.sort, 'call');

  (0, _sort2.default)(l, f);
  ...
  t.true(_rec._expr(_rec._capt(_rec._capt(Spy, 'arguments/0/callee/object').calledWith(_rec._capt(_rec._capt(l, 'arguments/0/arguments/0/object').__data__, 'arguments/0/arguments/0'), _rec._capt(f, 'arguments/0/arguments/1')), 'arguments/0'), {
    ...
    filepath: 'tests/list/sort.spec.js',
    line: 36,
...
//# sourceMappingURL=../../node_modules/.cache/ava/655474c10e7b53f13410275a163ee1ce.js.map
...
var _every = require('../../source/list/every');
...
(0, _ava2.default)('list#every: should be curryable', function (t) {
  t.is((0, _every2.default)(_curry._), _every2.default);
});

(0, _ava2.default)('list#every: should call Array.prototype.every w/ __data__', function (t) {
  ...
  var Spy = _sinon2.default.spy(Array.prototype.every, 'call');

  (0, _every2.default)(l, f);
  ...
  t.true(_rec._expr(_rec._capt(_rec._capt(Spy, 'arguments/0/callee/object').calledWith(_rec._capt(_rec._capt(l, 'arguments/0/arguments/0/object').__data__, 'arguments/0/arguments/0'), _rec._capt(f, 'arguments/0/arguments/1')), 'arguments/0'), {
    ...
    filepath: 'tests/list/every.spec.js',
    line: 27,
...
//# sourceMappingURL=../../node_modules/.cache/ava/3948a94e5ccdbf7f2090f9d533e40ff5.js.map
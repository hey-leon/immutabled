...
test('map.partition: should return all to the left', t => {
  ...
  const [ m2, m3 ] =
    partition(m1, v => v === F.currString1 || v === F.currString2)

  t.is(m2.__size__, 2)
  t.is(m3.__size__, 0)
  t.deepEqual(m2.__data__, { a: F.currString1, b: F.currString2 })
  t.deepEqual(m3.__data__, {})
})
...
test('map.partition: should return mix of left and right', t => {
  ...
  const [ m2, m3 ] =
    partition(m1, v => v === F.currString1)

  t.is(m2.__size__, 1)
  t.is(m3.__size__, 1)
  t.deepEqual(m2.__data__, { a: F.currString1 })
  t.deepEqual(m3.__data__, { b: F.currString2 })
})
